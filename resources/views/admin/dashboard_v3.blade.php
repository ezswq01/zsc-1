        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start">
            <h3 class="mb-0 display-4">
              <span x-text="registeredLocations ? Object.keys(registeredLocations).length : 0"></span>
            </h3>
    ...
    <div class="col-lg-3 col-12">
      <div class="card text-white shadow-lg" style="background-color: rgb(0, 100, 0);">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start">
            <h3 class="mb-0 display-4">
              <span x-text="activeLocations ? Object.keys(activeLocations).length : 0"></span>
            </h3>
            <div class="d-flex justify-content-between align-items-start gap-2">
              <button
                type="button"
    ...
    <div class="col-lg-3 col-12">
      <div class="card text-white shadow-lg" style="background-color: rgb(0, 100, 0);">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start">
            <h3 class="mb-0 display-4">
              <span x-text="inactiveLocations ? Object.keys(inactiveLocations).length : 0"></span>
            </h3>
            <div class="d-flex justify-content-between align-items-start gap-2">
              <button
                type="button"
