        ...
        <div class="page-header-content d-lg-flex">
            <div class="d-flex">
                <h4 class="page-title mb-0">
                    Change Password - <span class="fw-normal">Detail</span>
                </h4>
            </div>
        </div>
...
@section("content")
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Edit Change Password</h5>
        </div>
                ...
                <div class="col-lg-8 col-12">
                    <form action="/admin/change-password" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" value="" name="old_password"
                                    placeholder="Type Old Password" required type="password">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-4 col-form-label">New Password</label>
                            <div class="col-lg-8">
                                <input class="form-control" value="" name="password" placeholder="Type New Password"
