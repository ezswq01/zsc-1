        ...
        <div class="col-lg-8 col-12">
          <form action="{{ route('admin.devices.update', $data->id) }}" method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-lg-8">
                <input class="form-control" name="name" placeholder="Type Name" required type="text" value="{{ $data->name }}">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-lg-8">
                <input class="form-control" name="desc" placeholder="Type Description" required type="text" value="{{ $data->desc }}">
              </div>
            </div>
