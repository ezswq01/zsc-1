                ...
                <div class="col-lg-8 col-12">
                    <form action="{{ route("admin.devices.update", $data->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" value="{{ $data->device_id }}" name="device_id"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" value="{{ $data->sensor_id }}" name="sensor_id"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input value="{{ old("branch", $data->branch) }}" class="form-control" name="branch"
                                    placeholder="Type Location" required type="text" d>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-lg-4 col-form-label">Sub-Location</label>
                            <div class="col-lg-8">
                                <input value="{{ old("building", $data->building) }}" class="form-control" name="building"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input value="{{ old("room", $data->room) }}" class="form-control" name="room"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control select" data-placeholder="Select Device Type"
                                    name="device_type_id">
                                    <option></option>
    ...
    <div class="publish_html" style="display: none;">
        <div class="publish_element">
            ...
            <div class="text-start mt-3">
                <button class="btn btn-danger" type="button" data-publish_actions="1"
                    onclick="handleDeletePublishActions(this)">Delete</button>
            </div>
        </div>
    </div>
    <div class="subscribe_html" style="display: none;">
        <div class="subscribe_element">
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-8">
                    <input class="form-control" name="subscribe_expressions[expression][]"
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-8 d-flex align-items-center">
                    <select class="form-control select2modify" data-placeholder="Select State"
            ...
            <div class="text-start mt-3">
                <button class="btn btn-danger" type="button" data-subscribe_expression="1"
                    onclick="handleDeleteSubscribeExpression(this)">Delete</button>
            </div>
        </div>
    </div>
@endsection
