        ...
        <div class="col-lg-8 col-12">
          <form action="{{ route('admin.devices.store') }}" method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-lg-8">
                <input disabled class="form-control" value="{{ $data->subscribe_topic }}" name="subscribe_topic"
            ...
            <div class="row mb-3">
              ...
              <div class="col-lg-8">
                <input disabled class="form-control" value="{{ $data->publish_topic }}" name="publish_topic"
  ...
  <div class="publish_html" style="display: none;">
    <div class="publish_element">
      ...
      <div class="row mt-3">
        ...
        <div class="col-lg-8">
          <input disabled class="form-control" name="publish_actions[label][]" placeholder="Type Button Label" required
            type="text">
        </div>
      </div>
      <div class="row mt-3">
        ...
        <div class="col-lg-8">
          <input disabled class="form-control" name="publish_actions[value][]" placeholder="Type Publish Value" required
            type="text">
        </div>
      </div>
    ...
    $(document).ready(function() {
      if (dataSubscribeExpressions.length > 0) {
        dataSubscribeExpressions.forEach((item, index) => {
          ...
          $(`.subscribe_expression_${index + 1} input[name="subscribe_expressions[expression][]"]`).val(item
            .expression);
          $(`.subscribe_expression_${index + 1} select[name="subscribe_expressions[status_type][]"]`).val(item
