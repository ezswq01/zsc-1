            ...
            <div class="col-lg-8 col-12">
                <form action="{{ route('admin.devices.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-8">
                            <input disabled class="form-control" value="{{ $data->device_id }}" name="device_id" placeholder="Type Device ID" required type="text">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-lg-4 col-form-label">Subscribe Topic</label>
                        <div class="col-lg-8">
                            <input disabled class="form-control" value="{{ $data->subscribe_topic }}" name="subscribe_topic" placeholder="Type Subscribe Topic" required type="text">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-lg-4 col-form-label">Publish Topic</label>
                        <div class="col-lg-8">
                            <input disabled class="form-control" value="{{ $data->publish_topic }}" name="publish_topic" placeholder="Type Publish Topic" required type="text">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="text-end">
                      <a href="{{ route('admin.devices.edit', $data->id) }}" class="btn btn-primary" type="submit">Edit</a>
                    </div>
                </form>
            </div>
        </div>
...
<div class="publish_html" style="display: none;">
    <div class="publish_element">
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-8">
                <input disabled class="form-control" name="publish_actions[label][]" placeholder="Type Button Label" required type="text">
            </div>
        </div>
        <div class="row mt-3">
            <label class="col-lg-4 col-form-label">Publish Value</label>
            <div class="col-lg-8">
                <input disabled class="form-control" name="publish_actions[value][]" placeholder="Type Publish Value" required type="text">
            </div>
        </div>
    </div>
</div>
<div class="subscribe_html" style="display: none;">
    <div class="subscribe_element">
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-8">
                <input disabled class="form-control" name="subscribe_expressions[expression][]" placeholder="Type Expression, e.g : &#123;&#123;value&#125;&#125; > 10" required type="text">
            </div>
        </div>
        <div class="row mt-3">
            <label class="col-lg-4 col-form-label">Status Type</label>
            <div class="col-lg-8">
                <select disabled class="form-control select2modify" data-placeholder="Select Status Type" name="subscribe_expressions[status_type][]">
                    <option></option>
                    @foreach (\App\Models\DeviceType::all() as $device_type)
