    ...
    <div class="page-header-content d-lg-flex">
      <div class="d-flex">
        <h4 class="page-title mb-0">
          Device - <span class="fw-normal">Create</span>
        </h4>
      </div>
    </div>
        ...
        <div class="col-lg-8 col-12">
          <form action="{{ route('admin.devices.store') }}" method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-lg-8">
                <input class="form-control" name="id" placeholder="Type Device ID" required type="text">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-lg-4 col-form-label">Subscribe Topic</label>
              <div class="col-lg-8">
                <input class="form-control" name="subscribe_topic" placeholder="Type Subscribe Topic" required
                  type="text">
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-lg-8">
                <input class="form-control" name="publish_topic" placeholder="Type Publish Topic" required type="text">
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="col-lg-8">
                <select class="form-control select" data-placeholder="Select Device Type" name="device_type_id">
                  <option></option>
                  @foreach (collect([]) as $device_type)
  ...
  <div class="subscribe_html" style="display: none;">
    <div class="subscribe_element">
      ...
      <div class="row mt-3">
        ...
        <div class="col-lg-8">
          <input class="form-control" name="subscribe_expressions[expression][]" placeholder="Type Expression, e.g : {value} > 10"
            required type="text">
        </div>
      </div>
      <div class="row mt-3">
