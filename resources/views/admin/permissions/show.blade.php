        ...
        <div class="page-header-content d-lg-flex">
            <div class="d-flex">
                <h4 class="page-title mb-0">
                    Permission - <span class="fw-normal">Detail</span>
                </h4>
            </div>
        </div>
        ...
        <div class="page-header-content d-lg-flex">
            <div class="d-flex">
                <div class="breadcrumb py-2">
                    ...
                    <a class="breadcrumb-item" href="{{ route('admin.permissions.index') }}">Permission</a>
...
@section('content')
    <div class="card shadow-none">
        <div class="card-header">
            <h5 class="mb-0">Detail Permission</h5>
        </div>
                ...
                <div class="col-lg-8 col-12">
                    <form>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input value="{{ $permission->name }}" class="form-control" name="name"
