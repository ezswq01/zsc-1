      ...
      <ul class="nav nav-sidebar" data-nav-type="accordion">
        ...
        @canany(["devices-read", "device-types-read", "device-logs-read"])
          ...
          @can("users-read")
            <li
              ...
              <ul class="nav-group-sub collapse {{ $active == "absent_devices" ? "show" : "" }}">
                ...
                @can("users-create")
                  <li class="nav-item"><a class="nav-link" href="{{ route("admin.absent_devices.create") }}">Create</a>
                  </li>
                @endcan
              </ul>
            </li>
          ...
          @can("device-logs-read")
            <li class="nav-item nav-item-submenu {{ $active == "device_logs" ? "nav-item-expanded nav-item-open" : "" }}">
              <a class="nav-link" href="#">
            ...
            <li class="nav-item nav-item-submenu {{ $active == "permissions" ? "nav-item-expanded nav-item-open" : "" }}">
              ...
              <ul class="nav-group-sub collapse {{ $active == "permissions" ? "show" : "" }}">
                ...
                @can("permissions-create")
                  <li class="nav-item"><a class="nav-link" href="{{ route("admin.permissions.create") }}">Create</a>
                  </li>
                @endcan
              </ul>
            </li>
