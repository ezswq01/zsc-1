        ...
        <div class="col-lg-8 col-12">
          <form action="{{ route('admin.status_types.store') }}" method="POST">
            ...
            <div class="row mb-3">
              ...
              <div class="col-lg-8">
                <input class="form-control form-control-color" disabled value="{{ old('color', $data->color) }}"
                  type="color" name="color">
              </div>
            </div>
            <div class="text-end">
              <a href="{{ route('admin.status_types.edit', $data->id) }}" class="btn btn-primary" type="submit">Edit</a>
            </div>
          </form>
        </div>
      </div>
