        ...
        <div class="page-header-content d-lg-flex">
            <div class="d-flex">
                <h4 class="page-title mb-0">
                    Role - <span class="fw-normal">Detail</span>
                </h4>
            </div>
        </div>
        ...
        <div class="page-header-content d-lg-flex border-top">
            <div class="d-flex">
                <div class="breadcrumb py-2">
                    ...
                    <a class="breadcrumb-item" href="{{ route('admin.roles.index') }}">Role</a>
                ...
                <div class="col-lg-8 col-12">
                    <form>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input value="{{ $role->name }}" class="form-control" name="name"
                                    placeholder="Type Name" required type="text" disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control select" data-placeholder="Select Permissions"
                                    name="permissions[]" multiple="multiple" disabled>
                                    @foreach ($permissions as $key => $permission)
                                        <optgroup label="{{ Str::upper($key) }}">
                                            @foreach ($permission as $item)
                                                <option value="{{ $item->name }}"
                                                    {{ $role->hasPermissionTo($item->name) ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </optgroup>
