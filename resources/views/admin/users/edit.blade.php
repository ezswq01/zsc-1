                ...
                <div class="col-lg-8 col-12">
                    <form action="{{ route("admin.users.update", $user->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input value="{{ old("user_code", $user->user_code) }}" class="form-control"
                                    name="user_code" placeholder="Type User Code" required type="text">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control select" data-placeholder="Select Access Device Type"
                                    ...
                                    @foreach ($absent_devices as $absent_device)
                                        <option {{ old("absent_device_id", $user->absent_device_id) == $absent_device->id ? "selected" : "" }}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input value="{{ old("job_position", $user->job_position) }}" class="form-control" name="job_position"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input value="{{ old("work_area", $user->work_area) }}" class="form-control" name="work_area"
