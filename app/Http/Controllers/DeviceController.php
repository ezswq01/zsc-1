...
class DeviceController extends Controller
{
  ...
  public function getRegisteredLocations()
  {
    ...
    $registeredLocations = Device::all()->count() > 0 ? Device::all()->groupBy('room') : null;
    $activeLocations = $onlineDevices->count() > 0 ? $onlineDevices->groupBy('room') : null;
    $inactiveLocations = $inactiveDevices->count() > 0 ? $inactiveDevices->groupBy('room') : null;
