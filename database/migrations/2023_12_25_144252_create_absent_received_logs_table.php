...
class CreateAbsentReceivedLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('absent_received_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('absent_received_logs');
    }
}
