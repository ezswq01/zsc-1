...
CREATE TABLE public.locations (
    ...
    coordinate character varying(50),
...
CREATE TABLE public.status_types (
    ...
    category character varying(255) DEFAULT 'info'::character varying NOT NULL
);
...
--
-- Name: locations locations_last_updated_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.locations
    ADD CONSTRAINT locations_last_updated_by_foreign FOREIGN KEY (last_updated_by) REFERENCES public.users(id) ON DELETE SET NULL;
